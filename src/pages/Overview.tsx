        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {/* Interests & Hobbies - Separate section */}
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {interests.map((interest, index) => (
                      <div key={index} className="group/item p-4 rounded-lg bg-primary/10 hover:bg-primary/15 transition-all duration-300 cursor-pointer text-center">
                        <div className="text-2xl mb-2 group-hover/item:scale-125 transition-transform duration-300">
                          {interest.icon}
                        </div>
                        <div className="font-semibold text-sm text-foreground group-hover/item:text-primary transition-colors duration-300 mb-1">
                          {interest.name}
                        </div>
                  ...
                  <div className="mt-6 p-4 rounded-lg bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-400/30">
