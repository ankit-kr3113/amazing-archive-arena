    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              <MdCompareArrows className="w-5 h-5 text-primary" />
              <h2 className="text-xl md:text-2xl font-bold text-foreground">Platform Comparison</h2>
            </div>

            <Card className="group bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20 hover:border-primary/40 transition-all duration-300">
              <div className="p-4">
                  ...
                  {codingStats.map((platform, index) => {
                    ...
                    return (
                      <div key={index} className="text-center">
                        ...
                        <h3 className="text-sm font-semibold text-foreground mb-1">{platform.platform}</h3>
                        <div className="space-y-1">
                          <div className="text-lg font-bold text-primary">{animatedCounts.platforms[index]}</div>
                          <Progress value={platform.progress} className="h-1.5" />
                          <div className="text-xs text-muted-foreground">{platform.progress}% Complete</div>
                        </div>
                      </div>
                    );
                  })}
          ...
          <div className="mb-12">
            <div className="flex items-center gap-2 mb-6">
              <MdTimeline className="w-5 h-5 text-primary" />
              ...
              <div className="p-4">
                <div className="space-y-3">
                  {recentActivity.map((activity, index) => (
                    <div key={index} className="flex items-start gap-3 p-3 bg-card/50 rounded-lg border border-primary/10 hover:border-primary/20 transition-all duration-300">
                      <div className="flex-shrink-0">
                        <div className={`w-2 h-2 rounded-full mt-2 ${
                          activity.type === 'contest' ? 'bg-orange-400' :
                          activity.type === 'milestone' ? 'bg-yellow-400' :
                          activity.type === 'challenge' ? 'bg-green-400' : 'bg-blue-400'
                        }`}></div>
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-1">
                          <p className="text-sm text-foreground font-medium">{activity.activity}</p>
